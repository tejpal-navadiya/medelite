...
<div class="row col-sm-12" id="content_item1">
                            ...
                            <div class="col-sm-6 col-md-4">
                                ...
                                <div class="form-group">
                                    <select name="license_type[]"  <?php echo $disabled;?> class="form-control select2" data-is_validate="1" id="license_type<?php echo $cnt; ?>">
                            ...
                            <div class="col-sm-6 col-md-4">
                                ...
                                <div class="form-group">
                                    <select name="license_state[]"  <?php echo $disabled;?> class="form-control state_dropdown" data-is_validate="1" id="license_state<?php echo $cnt; ?>" data-val_sel="<?php if(isset($cur_detail['license_state_name_sel'])){ echo base64_encode($cur_detail['license_state_name_sel']);} ?>">
                            ...
                            <div class="col-sm-6 col-md-4">
                                ...
                                <div class="form-group">
                                    <input type="text" name="license_no[]"  <?php echo $readonly;?> id="license_no<?php echo $cnt; ?>" data-is_validate="1"  class="form-control" placeholder="License Number" value="<?php if(isset($cur_detail['license_no'])){ echo $cur_detail['license_no'];} ?>"  >
                                    <span class="help" id="msg2"></span>
                                </div>
                            </div>
                            <div class="col-sm-6 col-md-4">
                                ...
                                <div class="form-group">
                                    <input type="text"  name="issue_date[]" id="issue_date<?php echo $cnt; ?>"   <?php echo $disabled;?> data-is_validate="1"  class="form-control datepicker" placeholder="mm/dd/yyyy" value="<?php if(isset($cur_detail['issue_date'])){ echo $cur_detail['issue_date'];} ?>">
                                    <span class="help" id="msg2"></span>
                                </div>
                            </div>
                            <div class="col-sm-6 col-md-4">
                                ...
                                <div class="form-group">
                                    <input type="text"  name="expiry_date[]" id="expiry_date<?php echo $cnt; ?>"  <?php echo $disabled;?> data-is_validate="1"  class="form-control datepicker" placeholder="mm/dd/yyyy" value="<?php if(isset($cur_detail['expiry_date'])){ echo $cur_detail['expiry_date'];} ?>">
                                    <span class="help" id="msg2"></span>
                                </div>
                            </div>
                            <div class="col-sm-6 col-md-4">
                                ...
                                <div class="form-group">
                                    <select name="primary_license[]"  <?php echo $disabled;?> class="form-control" id="primary_license<?php echo $cnt; ?>">
                            ...
                            <div class="col-sm-6 col-md-4">
                                ...
                                <div class="form-group">
                                    <select name="compact_license[]"  <?php echo $disabled;?> class="form-control" id="compact_license<?php echo $cnt; ?>">
                            ...
                            <div class="col-sm-6 col-md-4">
                                ...
                                <div class="form-group">
                                    <select name="license_status[]"  <?php echo $disabled;?> class="form-control select2" data-is_validate="1" id="license_status<?php echo $cnt; ?>">
