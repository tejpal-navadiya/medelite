            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-sm-6">
                                <h3 class="card-title"><?php if(isset($_REQUEST['id'])) {echo "Update";}else{echo "Add";} ?> User Role</h3>
                            </div>
                    ...
                    <div class="card-body">
                    <form class="form-horizontal" id="user_role_form"  method="post" >
                        ...
                        <?php
                                    ...
                                    $fetch=mysqli_fetch_assoc($sel_file_details);
                                        ...
                                        echo '<input type="hidden" name="id" id="user_role_id" value="'.$_REQUEST['id'].'">';
                                        // print_r($fetch);
                                    } ?>
                                    <!-- <div class="col-md-6">
