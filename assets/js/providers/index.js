        ...
        "render": function(data, type, row, meta)
        {
          var btnGroup='<div class="btn-group">'+
                          '<a href="index.php?pid=add_provider&id='+row.id+'" class="btn btn-outline-primary btn-sm"><i class="fas fa-edit"></i></a>'+
                           '<button type="button" class="btn btn-sm btn-outline-primary"><i class="fas fa-file-alt"></i><i class="fas fa-search"></i></button>' + // Load button with icon
                           '<button type="button" class="btn btn-sm btn-outline-primary"><i class="fas fa-phone"></i></button>' + // Load button with icon
                          '<button type="button" class="btn btn-sm btn-outline-primary"><i class="fas fa-envelope"></i></button>' + // Load button with icon
                          '<button type="button" class="btn btn-sm btn-outline-primary"><i class="fas fa-hand-holding-usd"></i></button>' + // Cross button
    ...
    bootbox.confirm({
      ...
      callback: function (result) 
      {
        ...
        if(result)
        {
          ...
          $.ajax({
            type: "POST",
            url: api_url+"provider/delete.php",
            headers: {
              'apitoken': apitoken
            },
            data: {
