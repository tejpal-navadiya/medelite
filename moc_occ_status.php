            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-6">
                                <h3 class="card-title">MOC/OCC Status List</h3>
                            </div>
                            <div class="col-md-6 text-right">
                                <a href="index.php?pid=add_moc_occ_status" class="btn btn-primary btn-sm"><i class="fas fa-plus"></i> Add New MOC/OCC Status</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <table id="moc_occ_statusTable" class="data-table table table-hover" style="border:1px solid grey;">
                        <thead>
                            <tr>
                                <th><input type="checkbox" id="select_all_moc_occ_status" name="select_all_moc_occ_status" />
