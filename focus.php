            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-6">
                                <h3 class="card-title">focus List</h3>
                            </div>
                            <div class="col-md-6 text-right">
                                <a href="index.php?pid=add_focus" class="btn btn-primary btn-sm"><i class="fas fa-plus"></i> Add New Focus</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <table id="focusTable" class="data-table table table-hover" style="border:1px solid grey;">
                        <thead>
                            <tr>
                                <th><input type="checkbox" id="select_all_focus" name="select_all_focus" />
