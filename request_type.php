            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-6">
                                <h3 class="card-title">Request Type List</h3>
                            </div>
                            <div class="col-md-6 text-right">
                                <a href="index.php?pid=add_request_type" class="btn btn-primary btn-sm"><i class="fas fa-plus"></i> Add New Request Type</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <table id="request_typeTable" class="data-table table table-hover" style="border:1px solid grey;">
                        <thead>
                            <tr>
                                <th><input type="checkbox" id="select_all_request_type" name="select_all_request_type" />
