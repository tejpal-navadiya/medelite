        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-md-6 text-right">
                                <a href="index.php?pid=add_degree" class="btn btn-primary btn-sm"><i class="fas fa-plus"></i> Add New Degree</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <table id="degree_Table" class="data-table table table-hover" style="border:1px solid grey;">
                        <thead>
                            <tr>
                                <th><input type="checkbox" id="select_all_degree" name="select_all_degree" />
