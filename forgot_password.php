            ...
            <div class="custom-login-card card-outline">
                    ...
                    <form action="process/check_login.php" method="post">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" name="login_username" required class="form-control" value="" placeholder="User Name">
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 text-right">
                                <a href="reset_password.php" class="btn cutom-login-light-button btn-block">Forgot Password</a>        
                            </div>
