            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-6">
                                <h3 class="card-title">Providers Ethnicity List</h3>
                            </div>
                            <div class="col-md-6 text-right">
                                <a href="index.php?pid=add_provider_ethnicity" class="btn btn-primary btn-sm"><i class="fas fa-plus"></i> Add New Provider Ethnicity</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <table id="provider_ethnicityTable" class="data-table table table-hover" style="border:1px solid grey;">
                        <thead>
                            <tr>
                                <th><input type="checkbox" id="select_all_providers_ethnicity" name="select_all_providers_ethnicity" />
