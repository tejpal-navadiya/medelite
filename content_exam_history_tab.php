            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <?php 
                        ...
                        {
                    ?>
                    <a href="index.php?pid=add_boarding_form&tab=board-certification&id=<?php echo $_REQUEST['id'];?>"  class="btn-pill btn-shadow btn-wide fsize-1 btn btn-primary">Next</a>
                    <?php }else{ ?>
