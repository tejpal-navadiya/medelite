	...
	try{
		...
		if(isset($headers['Apitoken']) || isset($headers['apitoken']) || isset($_REQUEST['apitoken']))
		{
			...
			if($apitoken ){
				...
				// $ac_data_qry = "SELECT id FROM me_onboarding_personal_details WHERE id=? AND firm_id=? limit 1";
				$ac_data_qry = "SELECT id FROM me_onboarding_personal_details WHERE id=?  limit 1";
				...
				if($ac_data_result->num_rows){
					...
					$update_pa_qry = "UPDATE me_onboarding_personal_details SET title='$title',first_name='$first_name',middle_name='$middle_name',last_name='$last_name',provider_type='$provider_type',maiden_other_alias='$maiden_other_alias',personal_email='$personal_email',personal_mobile_no='$personal_mobile_no',personal_address_line_1='$personal_address_line_1',personal_address_line_2='$personal_address_line_2',personal_address_city='$personal_address_city',personal_address_state='$personal_address_state',personal_address_country='$personal_address_country',personal_address_zipcode='$personal_address_zipcode',business_email='$business_email',business_phone='$business_phone',business_address_line_1='$business_address_line_1',business_address_line_2='$business_address_line_2',business_address_city='$business_address_city',business_address_state='$business_address_state',business_address_country='$business_address_country',business_address_zipcode='$business_address_zipcode',gender='$gender',dob='$dob',birth_city='$birth_city',birth_state='$birth_state',birth_country='$birth_country',country_of_citizenship='$country_of_citizenship',ethnicity='$ethnicity',hair_color='$hair_color',eye_color='$eye_color',height_feet='$height_feet',height_in='$height_in',weight_lbs='$weight_lbs',is_us_citizen='$is_us_citizen',driver_licence='$driver_licence',state_issued='$state_issued',fcvs_id='$fcvs_id',issue_date='$issue_date',expiry_date='$expiry_date',caqh_no='$caqh_no',npi_no='$npi_no',ssn_no='$ssn_no',tin_no='$tin_no',is_military_person='$is_military_person',is_partner_military_person='$is_partner_military_person',branch='$branch',service_start_date='$service_start_date',service_end_date='$service_end_date',discharge_rank='$discharge_rank',discharge_type='$discharge_type',other_honor_detail='$other_honor_detail',institute_gap_confirmation='$institute_gap_confirmation', updated_by='$updated_by', updated_at='$updated_at',suffix='$suffix' WHERE id='$id' ";
