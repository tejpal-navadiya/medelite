        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-md-6 text-right">
                                <a href="index.php?pid=add_website" class="btn btn-primary btn-sm"><i class="fas fa-plus"></i> Add New Website</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <table id="websiteTable" class="data-table table table-hover" style="border:1px solid grey;">
                        <thead>
                            <tr>
                                <th><input type="checkbox" id="select_all_website" name="select_all_website" />
