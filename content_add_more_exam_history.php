...
<div class="row col-sm-12" id="content_item<?php echo $cnt; ?>">                        
    ...
    <div class="col-sm-6 col-md-4">
        ...
        <div class="form-group">
            <select name="exam_type[]" class="form-control select2"  <?php echo $disabled;?> id="exam_type<?php echo $cnt; ?>">
    ...
    <div class="col-sm-6 col-md-4">
        ...
        <div class="form-group">
            <select name="examination[]" class="form-control"  <?php echo $disabled;?> id="examination<?php echo $cnt; ?>">
    ...
    <div class="col-sm-6 col-md-4">
        ...
        <div class="form-group">
            <select name="no_of_attempts[]" class="form-control"  <?php echo $disabled;?> data-is_validate="1" id="no_of_attempts<?php echo $cnt; ?>">
    ...
    <div class="col-sm-6 col-md-4">
        ...
        <div class="form-group">
            <input type="number" name="score[]" id="score<?php echo $cnt; ?>" <?php echo $readonly;?> data-is_validate="1"  class="form-control " placeholder="Score" value="<?php if(isset($cur_detail['score'])){ echo $cur_detail['score'];} ?>"  >
            <span class="help" id="msg2"></span>
        </div>
    </div>
    <div class="col-sm-6 col-md-4">
        ...
        <div class="form-group">
            <input type="text" maxlength="100" name="first_try_date[]" <?php echo $disabled;?> data-is_validate="1" id="first_try_date<?php echo $cnt; ?>"  class="form-control datepicker" placeholder="mm/dd/yyyy" value="<?php if(isset($cur_detail['first_try_date'])){ echo $cur_detail['first_try_date'];} ?>">
            <span class="help" id="msg2"></span>
        </div>
    </div>
    <div class="col-sm-6 col-md-4">
        ...
        <div class="form-group">
            <input type="text" maxlength="100" name="exam_date[]" <?php echo $disabled;?> data-is_validate="1" id="exam_date<?php echo $cnt; ?>"  class="form-control datepicker" placeholder="mm/dd/yyyy" value="<?php if(isset($cur_detail['exam_date'])){ echo $cur_detail['exam_date'];} ?>">
            <span class="help" id="msg2"></span>
        </div>
    </div>
    <div class="col-sm-6 col-md-4">
        ...
        <div class="form-group">
            <select name="is_passed[]" class="form-control"  <?php echo $disabled;?> id="is_passed<?php echo $cnt; ?>" data-is_validate="1">
    ...
    <div class="col-sm-8">
        ...
        <div class="form-group">
            <input type="text" name="location[]" id="location<?php echo $cnt; ?>"  <?php echo $readonly;?> class="form-control " placeholder="Location" value="<?php if(isset($cur_detail['location'])){ echo $cur_detail['location'];} ?>"  >
            <span class="help" id="msg2"></span>
        </div>
    </div>
    <div class="col-sm-12">
