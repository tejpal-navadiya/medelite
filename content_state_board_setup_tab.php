                    ...
                    <div class="row">    
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <input type="text" name="favorite_color" id="favorite_color"  class="form-control" placeholder="Favourite Color" value="<?php if(isset($other_details['favorite_color'])){echo $other_details['favorite_color'];} ?>"  >
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <input type="text" name="favorite_pet_name" id="favorite_pet_name"  class="form-control" placeholder="Favourite Pet Name" value="<?php if(isset($other_details['favorite_pet_name'])){echo $other_details['favorite_pet_name'];} ?>"  >
                                <span class="help" id="msg2"></span>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <input type="text" name="significant_meet" id="significant_meet"  class="form-control" placeholder="" value="<?php if(isset($other_details['significant_meet'])){echo $other_details['significant_meet'];} ?>"  >
                                <span class="help" id="msg2"></span>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <input type="text" name="vacation_destination" id="vacation_destination"  class="form-control" placeholder="" value="<?php if(isset($other_details['vacation_destination'])){echo $other_details['vacation_destination'];} ?>"  >
                                <span class="help" id="msg2"></span>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <input type="text" name="favorite_teacher" id="favorite_teacher"  class="form-control" placeholder="" value="<?php if(isset($other_details['favorite_teacher'])){echo $other_details['favorite_teacher'];} ?>"  >
                                <span class="help" id="msg2"></span>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <input type="text" name="father_middle_name" id="father_middle_name"  class="form-control" placeholder="" value="<?php if(isset($other_details['father_middle_name'])){echo $other_details['father_middle_name'];} ?>"  >
                                <span class="help" id="msg2"></span>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <input type="text" name="mother_middle_name" id="mother_middle_name"  class="form-control" placeholder="" value="<?php if(isset($other_details['mother_middle_name'])){echo $other_details['mother_middle_name'];} ?>"  >
                                <span class="help" id="msg2"></span>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <input type="text" name="born_hospital" id="born_hospital"  class="form-control" placeholder="" value="<?php if(isset($other_details['born_hospital'])){echo $other_details['born_hospital'];} ?>"  >
                                <span class="help" id="msg2"></span>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <input type="text" name="mother_born_city" id="mother_born_city"  class="form-control" placeholder="" value="<?php if(isset($other_details['mother_born_city'])){echo $other_details['mother_born_city'];} ?>"  >
                                <span class="help" id="msg2"></span>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <input type="text" name="last_name_bf_gf" id="last_name_bf_gf"  class="form-control" placeholder="" value="<?php if(isset($other_details['last_name_bf_gf'])){echo $other_details['last_name_bf_gf'];} ?>"  >
                                <span class="help" id="msg2"></span>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <input type="text" name="city_first_job" id="city_first_job"  class="form-control" placeholder="" value="<?php if(isset($other_details['city_first_job'])){echo $other_details['city_first_job'];} ?>"  >
                                <span class="help" id="msg2"></span>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <input type="text" name="street_name_grew_up" id="street_name_grew_up"  class="form-control" placeholder="" value="<?php if(isset($other_details['street_name_grew_up'])){echo $other_details['street_name_grew_up'];} ?>"  >
                                <span class="help" id="msg2"></span>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <input type="text" name="highschool_mascot" id="highschool_mascot"  class="form-control" placeholder="" value="<?php if(isset($other_details['highschool_mascot'])){echo $other_details['highschool_mascot'];} ?>"  >
                                <span class="help" id="msg2"></span>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <input type="text" name="make_model_first_car" id="make_model_first_car"  class="form-control" placeholder="" value="<?php if(isset($other_details['make_model_first_car'])){echo $other_details['make_model_first_car'];} ?>"  >
                                <span class="help" id="msg2"></span>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                <input type="text" name="company_name_first_job" id="company_name_first_job"  class="form-control" placeholder="" value="<?php if(isset($other_details['company_name_first_job'])){echo $other_details['company_name_first_job'];} ?>"  >
                                <span class="help" id="msg2"></span>
                            </div>
                        </div>
