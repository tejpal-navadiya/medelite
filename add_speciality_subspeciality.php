            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-sm-6">
                                <h3 class="card-title"><?php if(isset($_REQUEST['id'])) {echo "Update";}else{echo "Add";} ?> Speciality Subspeciality</h3>
                            </div>
                    ...
                    <div class="card-body">
                    <form class="form-horizontal" id="speciality_subspeciality_form"  action ='process/action_speciality_subspeciality_list.php' method="post" >
                        ...
                        <?php
                                    ...
                                    {
                                    $sel_file_details=mysqli_query($conn,"SELECT * from me_speciality_subspeciality WHERE id='".$_REQUEST['id']."' ");
