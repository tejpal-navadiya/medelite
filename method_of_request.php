            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-6">
                                <h3 class="card-title">Method of request List</h3>
                            </div>
                            <div class="col-md-6 text-right">
                                <a href="index.php?pid=add_method_of_request" class="btn btn-primary btn-sm"><i class="fas fa-plus"></i> Add New Method of request</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <table id="method_of_requestTable" class="data-table table table-hover" style="border:1px solid grey;">
                        <thead>
                            <tr>
                                <th><input type="checkbox" id="select_all_method_of_request" name="select_all_method_of_request" />
